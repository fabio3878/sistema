...
import type { ServicoResumo } from './tipos'
...
interface Props {
  ...
  onAlternarSituacao: (s: ServicoResumo) => void
}

const col = createColumnHelper<ServicoResumo>()

const moeda = new Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' })

export function ServicosTabela({ dados, carregando, podeEditar, onEditar, onAlternarSituacao }: Props) {
